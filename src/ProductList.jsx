...
function ProductList({ onHomeClick }) {
  ...
  const isPlantInTheCart = (plantName) => {
      ...
      <div className="navbar" style={styleObj}>
        <div className="tag">
          <div className="luxury">
            <img
              src="https://cdn.pixabay.com/photo/2019/08/04/20/48/flower-4384750_1280.jpg"
              alt=""
            />
            <a href="/" onClick={(e) => handleHomeClick(e)}>
              <div>
                <h3 style={{ color: "white" }}>BotaniHome</h3>
                <i style={{ color: "white" }}>We bring nature to your home!</i>
              </div>
            </a>
          </div>
        </div>
                  ...
                  <div className="product-card" key={plantIndex}>
                    ...
                    <button
                      className={`product-button ${
                        isPlantInTheCart(plant.name) ? "added-to-cart" : ""
                      }`}
                      onClick={() => handleAddToCart(plant)}
                      disabled={isPlantInTheCart(plant.name)}
                    >
                      {isPlantInTheCart(plant.name)
                        ? "Added to the Cart"
                        : "Add to Cart"}
                    </button>
                  </div>
